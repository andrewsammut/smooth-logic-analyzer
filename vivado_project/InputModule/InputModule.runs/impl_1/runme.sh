...
HD_PWD='C:/Users/Greg/Capstone/InputModule/InputModule.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log InputMod_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source InputMod_wrapper.tcl -notrace
