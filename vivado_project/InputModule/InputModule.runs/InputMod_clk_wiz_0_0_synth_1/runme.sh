...
HD_PWD='C:/Users/Greg/Capstone/InputModule/InputModule.runs/InputMod_clk_wiz_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log InputMod_clk_wiz_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source InputMod_clk_wiz_0_0.tcl
