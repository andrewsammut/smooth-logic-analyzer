...
HD_PWD='C:/Users/Greg/Capstone/InputModule/InputModule.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log InputMod_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source InputMod_wrapper.tcl
